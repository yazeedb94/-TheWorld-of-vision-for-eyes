        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-8">
          ...
          <div className="space-y-4">
            <div className="flex items-center space-x-2">
              ...
              <div>
                <h3 className="text-xl font-bold">مركز عالم الابصار للعيون</h3>
                <p className="text-sm text-gray-400">
                  {language === 'ar' ? 'مركز عالم الابصار للعيون' : 'Eye Clinic'}
                </p>
              </div>
            </div>
            ...
            <div className="space-y-3">
              <div className="flex items-start space-x-3">
                ...
                <div className="text-gray-400 text-sm">
                  <p>وسط الرياض : حي السليمانيه ، شارع التحليه</p>
                </div>
              </div>
              <div className="flex items-center space-x-3">
                <Phone className="h-5 w-5 text-blue-400 flex-shrink-0" />
                <a href="tel:+966583227788" className="text-gray-400 hover:text-white transition-colors duration-200 text-sm">
                  +966583227788
                </a>
              </div>
              <div className="flex items-center space-x-3">
